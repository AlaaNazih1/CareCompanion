import 'package:care_companion/services/caregiver_push_listener.dart';
import 'package:care_companion/services/fcm_registration_listener.dart';
...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return FcmRegistrationListener(
      child: CaregiverPushListener(
        child: MaterialApp(
          title: isElderly
